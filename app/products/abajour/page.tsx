...
export default async function AbajourPage() {
  const products = await supabaseLite.selectAll("products", { category: "abajour" }, "created_at", false);
  ...
  return (
    <main className="min-h-screen" style={{ background: "linear-gradient(160deg,#fffdf9 0%,#faf6ee 100%)" }}>
      <div className="relative overflow-hidden py-16 md:py-20 text-center px-6">
        ...
        <h1 className="text-3xl md:text-5xl text-gray-800">آباژور</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pb-16">
        {!products || products.length === 0 ? (
          ...
          <AnimatedProductGrid products={products} category="abajour" />
        )}
      </div>
      <BackButton />
    </main>
